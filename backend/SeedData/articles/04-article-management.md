...
Makale listesinde filtreler kompakt bir araç çubuğunda toplanır. Ayrıntılı durum, sınıflandırma, etiket, tarih aralığı ve “Makalelerim” kontrolleri gerektiğinde açılır; sıralama ve sonuç sayısı sürekli görünür. Aktif filtreler tek tek kaldırılabilen rozetlerle özetlenir. Sınıflandırma seçenekleri ve rozetleri Tanım Değerleri ekranında belirlenen Lucide ikonunu ve hazır ya da özel HEX rengini kullanır.
