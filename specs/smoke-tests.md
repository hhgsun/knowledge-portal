...
| 14a | Run `backend/scripts/run-mcp-live-quality-gate.ps1` against deployment | Modern MCP `ask_knowledge` reaches the live Ollama-backed RAG path and returns answer, evidence and trace IDs |
