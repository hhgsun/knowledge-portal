...
export default function AdminUsersPage() {
  ...
  const handleEditSave = async () => {
    ...
    const payload: Record<string, string | undefined> = { userId: editingUser.id };
    ...
    <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-6 p-5 border border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-950 rounded-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input type="email" value={addEmail} onChange={(e) => setAddEmail(e.target.value)} placeholder="user@example.com" className="w-full px-3 py-1.5 text-sm border border-zinc-300 dark:border-zinc-700 rounded-lg bg-white dark:bg-zinc-800" />
            </div>
            <div>
      ...
      {editingUser && (
        <div className="mb-6 p-5 border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950 rounded-xl">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-medium text-blue-900 dark:text-blue-100">Edit User: {editingUser.email}</h3>
            <button onClick={() => setEditingUser(null)} className="text-blue-500 hover:text-blue-700"><X size={16} /></button>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
              <label className="text-xs text-zinc-500 mb-1 block">Name</label>
      ...
      {pagination.pages > 1 && (
        <div className="flex items-center justify-between mt-4">
          ...
          <div className="flex items-center gap-1">
            <button onClick={() => loadUsers(pagination.page - 1, search)} disabled={pagination.page <= 1} className="p-1.5 rounded-lg border border-zinc-300 dark:border-zinc-700 disabled:opacity-30 hover:bg-zinc-50 dark:hover:bg-zinc-800">
              <ChevronLeft size={14} />
            </button>
            <button onClick={() => loadUsers(pagination.page + 1, search)} disabled={pagination.page >= pagination.pages} className="p-1.5 rounded-lg border border-zinc-300 dark:border-zinc-700 disabled:opacity-30 hover:bg-zinc-50 dark:hover:bg-zinc-800">
