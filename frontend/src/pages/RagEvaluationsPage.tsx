...
type Metrics = { recallAtK: number; mrr: number; ndcgAtK: number; factCoverage: number; citationCoverage: number; groundingCoverage: number; refusalAccuracy: number; forbiddenFactPassRate: number; conversationTaskAccuracy: number; retrievalDecisionAccuracy: number; p50LatencyMs: number; p95LatencyMs: number; passed: boolean; failedGates: string[] };
...
const defaultThresholds = { recallAtK: .8, mrr: .75, ndcgAtK: .75, factCoverage: .7, citationCoverage: .8, groundingCoverage: .8, refusalAccuracy: .9, forbiddenFactPassRate: 1, conversationTaskAccuracy: .9, retrievalDecisionAccuracy: .9, p95LatencyMs: 30000 };
const exampleCases = [
  { id: "ornek-1", category: "focused", question: "API key hangi header ile gönderilir?", expectedSourceSlugs: ["api-kullanim-kilavuzu"], expectedFacts: ["X-API-Key"], forbiddenFacts: [], expectedRefusal: false, filters: { tag: [], authorIds: [], contentType: [] } },
  { id: "konusma-1", category: "conversation", question: "MCP yanıtını sıralama takibi", expectedSourceSlugs: [], expectedFacts: [], forbiddenFacts: [], expectedRefusal: false, turns: [
    { message: "MCP nedir?", expectedIntent: "explain", expectedPresentation: "auto", expectedRetrieval: true },
