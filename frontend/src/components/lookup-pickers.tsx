  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className={`w-8 h-8 rounded-lg border border-zinc-200 dark:border-zinc-700 ${current.dot} ring-2 ring-offset-2 ring-offset-white dark:ring-offset-zinc-900 ring-zinc-300 dark:ring-zinc-600`}
