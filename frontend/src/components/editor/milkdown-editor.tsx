...
export default function MilkdownEditor({ contentMarkdown, onChange, uploadImage, deleteImage }: MilkdownEditorProps) {
  ...
  return <div className="milkdown-shell min-h-[28rem] overflow-hidden rounded-xl border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900"><div ref={rootRef} /></div>;
}
