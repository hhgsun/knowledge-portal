          ...
          <div className="flex items-start gap-2">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2 mt-2">
                <code className="text-xs bg-amber-100 dark:bg-amber-900 px-2 py-1 rounded font-mono break-all">
                  {createdKey}
                </code>
            ...
            <button onClick={() => setCreatedKey(null)} className="text-amber-500 hover:text-amber-700 text-sm">
              Dismiss
            </button>
          </div>
        </div>
      ...
      {showCreate && (
        <div className="mb-6 p-4 border border-zinc-200 dark:border-zinc-800 rounded-xl">
          ...
          <div className="flex items-end gap-3 flex-wrap">
            ...
            <button onClick={handleCreate} className="px-4 py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-sm rounded-lg">
              Create
            </button>
            <button onClick={() => setShowCreate(false)} className="px-4 py-1.5 text-sm text-zinc-500 hover:text-zinc-700">
              Cancel
            </button>
          </div>
          ...
          {keys.map((key) => (
            <div key={key.id} className="flex items-center justify-between p-4 border border-zinc-200 dark:border-zinc-800 rounded-xl">
              ...
              <button
                ...
                className="p-2 text-zinc-400 hover:text-red-500 rounded-lg hover:bg-red-50 dark:hover:bg-red-950"
              >
                <Trash2 size={16} />
              </button>
            </div>
